    ...
    <main className="menu-page page">
      ...
      {Object.keys(menu).length > 0 && (
        <div className="menu-page_sections">
          {menu.adventurous.length > 0 && (
            <MenuSection menuItems={menu.adventurous} />
          )}
          {menu.authentic.length > 0 && (
      ...
      {Object.keys(drinks).length && (
        <div className="menu-page_sections" id="drinks">
          ...
          {drinks.cocktails.length > 0 && (
            <DrinkSection drinkItems={drinks.cocktails} />
          )}
          {drinks.shooters.length > 0 && (
            <DrinkSection drinkItems={drinks.shooters} />
          )}
          {drinks.beerOnTap.length > 0 && (
            <DrinkSection drinkItems={drinks.beerOnTap} />
          )}
          {drinks.bottledBeer.length > 0 && (
            <DrinkSection drinkItems={drinks.bottledBeer} />
          )}
          {drinks.soju.length > 0 && <DrinkSection drinkItems={drinks.soju} />}
          {drinks.sake.length > 0 && <DrinkSection drinkItems={drinks.sake} />}
          {drinks.nonAlcoholic.length > 0 && (
            <DrinkSection drinkItems={drinks.nonAlcoholic} />
          )}
        </div>
      )}
    </main>
