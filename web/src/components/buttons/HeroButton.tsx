...
interface IProps<T extends HeroButtonType> {
	children?: any;
	color: Color,
	className?: string;
...
function HeroButton<T extends HeroButtonType>(props: IProps<T>): JSX.Element {
	...
	const fullClassNames: string = classNames("button", `button_color_${props.color}`, props.className);
